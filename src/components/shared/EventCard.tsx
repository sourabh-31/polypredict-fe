...
export default function EventCard({ event }: { event: Event }) {
  ...
  const handleTradeClick = (event, market, side) => {
    setSelectedEvent(event);
    setSelectedMarket({ ...market, selectedSide: side });
                ...
                <div key={market.id} className="space-y-3 mt-auto">
                  ...
                  <div className="flex gap-3">
                    <Button
                      ...
                      onClick={() =>
                        handleTradeClick(selectedEvent, market, "Yes")
                      }
                    >
                    ...
                    <Button
                      ...
                      className="flex-1 rounded-md py-2.5 hover:scale-[1.02]"
                      onClick={() =>
                        handleTradeClick(selectedEvent, market, "No")
                      }
                    >
